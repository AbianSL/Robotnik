...
# Parámetros D-H:
#      0->0'   0'->1     1->1',     1'->2,      2->3,       3->41,    3->42,     3->ef
d  = [   5,     -2,       0,          0,        5,          0,          0,          0]
th = [ p[0],    0,      p[1],         90,    p[2],       - 90 - p[3],       - 90 + p[3],         -90]
a  = [   0,     0,        3,          -2,       0,          1,          1,          1]
al = [  90,     0,       -90,         90,       -90,        -90,        -90,      -90]
...
T00_=matriz_T(d[0],th[0],a[0],al[0])
T0_1=matriz_T(d[1],th[1],a[1],al[1])
T11_=matriz_T(d[2],th[2],a[2],al[2])
T12= matriz_T(d[3],th[3],a[3],al[3])
...
# Cálculo de las matrices de transformación acumuladas
T01=np.dot(T00_,T0_1)
T01_=np.dot(T01,T11_)
T02=np.dot(T01_,T12)
T03=np.dot(T02,T23)
...
o0_0 =np.dot(T00_, o00_).tolist()
o10 =np.dot(T01,  o11).tolist()
o11_ =np.dot(T01_,o11_).tolist()
o20 =np.dot(T02,  o22).tolist()
o30 =np.dot(T03,  o33).tolist()
o41 =np.dot(T041, o441).tolist()
o42 =np.dot(T042, o442).tolist()
ef  =np.dot(T0ef, ef).tolist()


# Mostrar resultado de la cinemática directa
muestra_origenes([o00, o0_0, o10, o11_, o20, o30, [[o41], [o42]]], ef)
muestra_robot   ([o00, o0_0, o10, o11_, o20, o30, [[o41], [o42]]], ef)
input()
