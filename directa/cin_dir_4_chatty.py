...
# Parámetros D-H:
#        0→1  1→2   2→3   3→4   4→51  4→52  51→61 52→62  4→ef
d  = [ p[0],  0,    0,     0,  p[4], -p[4],   0,     0,    0]
th = [   0, p[1], p[2],    0,    0,     0,   0,  p[5],   0]
a  = [   2,   2,    0,     5,    1,     1,    p[5],     p[5],  1+p[5]]
al = [   0,  90,   0,      p[3],   90,    90,    0,     0,    0]
...
T661=matriz_T(d[6],th[6],a[6],al[6])
T662=matriz_T(d[7],th[7],a[7],al[7])
...
T061=np.dot(T051,T661)
T062=np.dot(T052,T662)
...
muestra_origenes([o00,o10,o20,o30, o40, [[o51, o61], [o52, o62]]], ef)
muestra_robot   ([o00,o10,o20,o30, o40, [[o51, o61], [o52, o62]]], ef)
input()
