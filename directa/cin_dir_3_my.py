...
th = [   0, p[1], -90,  0, p[3], 90+p[4], 90-p[4],  90]
a  = [   0,   5,    0,  0,  0,      2,      2,      2]
al = [   0, -90,  -90,  0,  90,   180,      180,     0]
...
T33_=matriz_T(d[3],th[3],a[3],al[3])
...
T04=np.dot(T03,T33_)
T05=np.dot(T04,T3_4)
T051=np.dot(T05,T451)
T052=np.dot(T05,T452)
T0ef=np.dot(T05,T4ef)
